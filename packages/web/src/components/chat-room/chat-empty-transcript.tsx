...
export function ChatEmptyTranscript(): ReactElement {
	...
	return (
		<div className="grid justify-items-center pt-[26dvh] text-center">
			<pre
				aria-hidden="true"
				className="m-0 select-none whitespace-pre font-mono text-[5px] font-medium leading-[1.08] text-[#5a5350] sm:text-[8px] md:text-[10px] lg:text-xs"
			>
				{DEVOS_ING_LOGO}
			</pre>
			<Typography as="h1" variant="srOnly">
				DEVOS.ING
			</Typography>
			{showDaemonSetup ? (
